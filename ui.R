...
ui <- dashboardPage(title="ReproSNP",
  ...
  #----------------------------------------------------------------------------------------------------
  dashboardHeader(title = span(img(src="ReproSNP_Logo.svg", width = 200)),
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      useShinyjs(),
      br(),
      actionBttn(inputId = "submit_button", label = "Submit", style = "simple", class="btn-success", width = "100%", size = "lg", no_outline= T),
      br(),
      ...
      # SNP SELECTION
      #----------------------------------------------------------------------------------------------------
      menuItem("Locus", tabName = "locus", startExpanded = T,
               selectizeInput(
                 inputId   = "gene_symbol",
      ...
      menuItem("Variant Filter", tabname = "varfilter", startExpanded=F,
      ...
      menuItem("Cohort I", tabName = "cohort1", startExpanded=F,
               ...
               sliderInput(inputId="cohort1_Number_of_children", label="Number of children", min=0, max=3, step=1, value=c(1,3), ticks=F),
      ...
      menuItem("Cohort II", tabName = "cohort2", startExpanded=F,
               ...
               sliderInput(inputId="cohort2_Number_of_children", label="Number of children", min=0, max=3, step=1, value=c(0,0), ticks=F),
